...
public class SlfLogUtil extends LogBase {
    ...
    static{
        System.getProperties().setProperty("org.slf4j.simpleLogger.showDateTime","true");
        System.getProperties().setProperty("org.slf4j.simpleLogger.dateTimeFormat","yyyy-MM-dd HH:mm:ss.SSS");
    }
    ...
    public static final String LOG_NAME = "defaultLogger";
